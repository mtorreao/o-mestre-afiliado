...
const SCHEMA = {
  ...
  /**
   * CSV de emails que viram admin automaticamente no login/register.
   * Vazio (default) = ninguém vira admin via env (use promoção manual no DB).
   */
  ADMIN_EMAILS: str('ADMIN_EMAILS', { default: '' }),
} as const;
